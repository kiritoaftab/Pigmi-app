import {
    View, Text, Image, Button, TouchableOpacity, TextInput, KeyboardAvoidingView, Platform,
    TouchableWithoutFeedback, Modal, Keyboard
} from "react-native";
...
const AddMoney = ({ user }) => {
    ...
    const [selectedAccountType, setSelectedAccountType] = useState('savings'); // Default account type
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.formWrapper}>
                            ...
                            <View style={styles.accountTypeSelection}>
                                ...
                                <Text>{JSON.stringify(user?.customerAccount)}</Text>
                                <View style={styles.radioGroup}>
                                    <TouchableOpacity
                                        onPress={() => handleAccountTypeChange('savings')}
                                        style={[
                                            styles.radioButton,
                                            selectedAccountType === 'savings' && styles.radioButtonSelected,
                                        ]}
                                    >
                                        <Text style={styles.radioText}>Savings</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity
                                        onPress={() => handleAccountTypeChange('deposit')}
                                        style={[
                                            styles.radioButton,
                                            selectedAccountType === 'deposit' && styles.radioButtonSelected,
                                        ]}
                                    >
                                        <Text style={styles.radioText}>Deposit</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity
                                        onPress={() => handleAccountTypeChange('fd')}
                                        style={[
                                            styles.radioButton,
                                            selectedAccountType === 'fd' && styles.radioButtonSelected,
                                        ]}
                                    >
                                        <Text style={styles.radioText}>FD</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
